...
# log.logger.info("Starting application setup in app.py...")
...
log.logger.debug(f"Added project root to sys.path: {project_root}")
...
log.logger.info("Importing tool modules...")
from src.tools import llm_tool
log.logger.debug("LLM tool module imported.")
from src.tools import image_tool
log.logger.debug("Image tool module imported.")
from src.tools import music_tool
log.logger.debug("Music tool module imported.")
from src.tools import video_tool
log.logger.debug("Video tool module imported.")
from src.tools import system_check_tool
log.logger.debug("System Check tool module imported.")
log.logger.info("All tool modules imported.")
